...
import Resume from "../resume/abhishek-kumar-resume.pdf";
    ...
    <div id="about" className="about section">
      ...
      <div id="about" className={style.about}>
        <div className={style.image}>
          {/* <BookType /> */}
          <img
            src="https://avatars.githubusercontent.com/u/140900975?v=4"
            alt="profile_img"
            className="home-img"
          />
        </div>
        <div className={style.name}>
          ...
          <p id="user-detail-intro">
            A aspiring and self motivated front-end web developer with
            expertise in creating ready to use website. Team collaborator with
            good interpersonal skill and tech skills such as Reach.js,
          ...
          <a
            ...
            {/*  */}
            <a
              href="https://github.com/abhishek10kumar"
            ...
            {/*  */}
            <a
              href="https://www.linkedin.com/in/abhishekprajapati569/"
              className={style.githubBtn}
              target="_blank"
              rel="noreferrer"
            >
